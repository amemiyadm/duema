...
class CardFactory:
    @staticmethod
    def create_card(id, name, civilizations, cost, power, race, card_type, trigger_abilities, static_abilities, mana_symbol):
        if card_type == 'creature':
            return Creature(id, name, civilizations, cost, power, race, card_type, trigger_abilities, static_abilities, mana_symbol)
        if card_type == 'spell':
            return Spell(id, name, civilizations, cost, power, race, card_type, trigger_abilities, static_abilities, mana_symbol)
